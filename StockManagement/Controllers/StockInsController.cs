...
namespace StockManagement.Controllers
{
    public class StockInsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,StockDate,Description")] StockIn stockIn)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,StockDate,Description")] StockIn stockIn)
        {
            if (ModelState.IsValid)
            {
